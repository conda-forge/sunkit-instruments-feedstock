...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/sunkit-instruments-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10913&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/sunkit-instruments-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `sunkit-instruments` can be installed with:

```
conda install sunkit-instruments
```

It is possible to list all of the versions of `sunkit-instruments` available on your platform with:
